...
var quotes: string[] = [
    ...
    '18) יצחקו עליכם אם תגידו למדתי LC-3 עם אליאס',
    '19) מחזור 15 אני ממליץ לכם לעשות כל מאמץ לקבל במבוא לחומרה ציון מדהים (90 ומעלה)',
    '20) ?"אני לא אוהבת את הביטוי הזה, מה זה "ברח לו',
    '21) יום טוב אור-אל',
    '22) קודם תגיע לירח ואז ניתן לך 5 שקל',
    '23) אסד? ההוא מהסוריה?',
    '24) אל תנסה לעצור אותי אני כמו סוס לא טוב',
    '25) בעזרת הנביא ישעיהו נבדוק אם הגרף 3 צביע',
    '26) זה כמו שאתה לא יכול ללמד נמלה לעשות אינטגרל',
    "27) jesus doesn't always save he makes backups",
    "28) Jeep",
